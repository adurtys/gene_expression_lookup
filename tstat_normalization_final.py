...
# TODO: This program rank-normalizes the t statistics in the "GTEx.tstat.tsv" file, which is formatted such that each row is a gene, and each
# column is the t statistic for the expression of that gene in the tissue corresponding to that column.
