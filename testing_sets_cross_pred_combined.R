# run with combined features (includes gene expression features)

# import data for run with no expression features
T2D_train   <-read.delim(file="/Users/rajadurty/Git/gene_expression_lookup/ML_tables/T2D_like_training_combined_ML_table.txt")
T2D_test    <-read.delim(file="/Users/rajadurty/Git/gene_expression_lookup/ML_tables/T2D_like_testing_combined_ML_table.txt")

lipid_train <-read.delim(file="/Users/rajadurty/Git/gene_expression_lookup/ML_tables/lipid_training_combined_ML_table.txt")
lipid_test  <-read.delim(file="/Users/rajadurty/Git/gene_expression_lookup/ML_tables/lipid_testing_combined_ML_table.txt")
...
# lipid model
T2D_train_data$lipid <- (-3.02282503 + T2D_train$hepatocyte_H3K27Ac_DMSO.bed*0.510915557 + T2D_train$Liver*0.258763414 + T2D_train$GSE64233_MED1_V_final.bed*0.07947421 + T2D_train$FAT.ADIP.NUC.EnhA*0.018096424)
T2D_test_data$lipid <- (-3.02282503 + T2D_test$hepatocyte_H3K27Ac_DMSO.bed*0.510915557 + T2D_test$Liver*0.258763414 + T2D_test$GSE64233_MED1_V_final.bed*0.07947421 + T2D_test$FAT.ADIP.NUC.EnhA*0.018096424)
lipid_train_data$lipid <- (-3.02282503 + lipid_train$hepatocyte_H3K27Ac_DMSO.bed*0.510915557 + lipid_train$Liver*0.258763414 + lipid_train$GSE64233_MED1_V_final.bed*0.07947421 + lipid_train$FAT.ADIP.NUC.EnhA*0.018096424)
lipid_test_data$lipid <- (-3.02282503 + lipid_test$hepatocyte_H3K27Ac_DMSO.bed*0.510915557 + lipid_test$Liver*0.258763414 + lipid_test$GSE64233_MED1_V_final.bed*0.07947421 + lipid_test$FAT.ADIP.NUC.EnhA*0.018096424)
...
T2D_test_data$T2D <- (-2.913749265 + T2D_test$FOXA2*0.668153897 + T2D_test$islet_diff_CpGregions_hg19.bed*0.448044729 + T2D_test$NKX2.2*0.329245952 + T2D_test$PancIslt.EnhA*0.118296882 + T2D_test$PDX1*0.106744796 + T2D_test$prostate_gland_transcription_profiling_by_array_assay_ENCFF001SOE.bed*0.053514704)
lipid_train_data$T2D <- (-2.913749265 + lipid_train$FOXA2*0.668153897 + lipid_train$islet_diff_CpGregions_hg19.bed*0.448044729 + lipid_train$NKX2.2*0.329245952 + lipid_train$PancIslt.EnhA*0.118296882 + lipid_train$PDX1*0.106744796 + lipid_train$prostate_gland_transcription_profiling_by_array_assay_ENCFF001SOE.bed*0.053514704)
lipid_test_data$T2D <- (-2.913749265 + lipid_test$FOXA2*0.668153897 + lipid_test$islet_diff_CpGregions_hg19.bed*0.448044729 + lipid_test$NKX2.2*0.329245952 + lipid_test$PancIslt.EnhA*0.118296882 + lipid_test$PDX1*0.106744796 + lipid_test$prostate_gland_transcription_profiling_by_array_assay_ENCFF001SOE.bed*0.053514704)
...
#training plots
pdf('/Users/rajadurty/Git/gene_expression_lookup/training_ROC_combined.pdf', width = 5, height = 5)
...
#plot it!
pdf('/Users/rajadurty/Git/gene_expression_lookup/testing_ROCs_combined.pdf', width = 15, height = 5)
