#import data
T2D_train   <-read.delim(file="C:\\Users\\Kim\\Documents\\ML\\V2\\NHGRI\\models\\T2D_like_lipid_alzheimer\\T2D_like_training_ML_table.txt")
T2D_test    <-read.delim(file="C:\\Users\\Kim\\Documents\\ML\\V2\\NHGRI\\models\\T2D_like_lipid_alzheimer\\T2D_like_testing_ML_table.txt")

lipid_train <-read.delim(file="C:\\Users\\Kim\\Documents\\ML\\V2\\NHGRI\\models\\T2D_like_lipid_alzheimer\\lipid_training_ML_table.txt")
lipid_test  <-read.delim(file="C:\\Users\\Kim\\Documents\\ML\\V2\\NHGRI\\models\\T2D_like_lipid_alzheimer\\lipid_testing_ML_table.txt")
...
#lipid model!
T2D_train_data$lipid   <- (-3.11469695 + T2D_train$hepatocyte_H3K27Ac_DMSO.bed*0.669428047 + T2D_train$HepG2_ChIP.seq_SREBF1_ENCFF001VLA.bed*0.242292069 + T2D_train$GSE64233_MED1_V_final.bed*0.22376704 + T2D_train$FAT.ADIP.NUC.EnhA*0.082257626 + T2D_train$E118.H3K27ac.gappedPeak*0.021026009)
T2D_test_data$lipid    <- (-3.11469695 + T2D_test$hepatocyte_H3K27Ac_DMSO.bed*0.669428047 + T2D_test$HepG2_ChIP.seq_SREBF1_ENCFF001VLA.bed*0.242292069 + T2D_test$GSE64233_MED1_V_final.bed*0.22376704 + T2D_test$FAT.ADIP.NUC.EnhA*0.082257626 + T2D_test$E118.H3K27ac.gappedPeak*0.021026009)
lipid_train_data$lipid <- (-3.11469695 + lipid_train$hepatocyte_H3K27Ac_DMSO.bed*0.669428047 + lipid_train$HepG2_ChIP.seq_SREBF1_ENCFF001VLA.bed*0.242292069 + lipid_train$GSE64233_MED1_V_final.bed*0.22376704 + lipid_train$FAT.ADIP.NUC.EnhA*0.082257626 + lipid_train$E118.H3K27ac.gappedPeak*0.021026009)
lipid_test_data$lipid  <- (-3.11469695 + lipid_test$hepatocyte_H3K27Ac_DMSO.bed*0.669428047 + lipid_test$HepG2_ChIP.seq_SREBF1_ENCFF001VLA.bed*0.242292069 + lipid_test$GSE64233_MED1_V_final.bed*0.22376704 + lipid_test$FAT.ADIP.NUC.EnhA*0.082257626 + lipid_test$E118.H3K27ac.gappedPeak*0.021026009)
...
#T2D model!
T2D_train_data$T2D   <- (-2.913749266 + T2D_train$FOXA2*0.668153897 + T2D_train$islet_diff_CpGregions_hg19.bed*0.448044731 + T2D_train$NKX2.2*0.329245952 + T2D_train$PancIslt.EnhA*0.118296882 + T2D_train$PDX1*0.106744797 + T2D_train$prostate_gland_transcription_profiling_by_array_assay_ENCFF001SOE.bed*0.053514704)
...
#training plots
pdf('C:\\Users\\Kim\\Documents\\ML\\V2\\NHGRI\\models\\T2D_like_lipid_alzheimer\\training_ROC.pdf', width = 5, height = 5)

plot(alz_training.perf, main=toupper("ROC for training"), col = "orangered1", cex.axis = 3, lwd = 2)
par(new=TRUE)
plot(lipid_training.perf, col = "purple1", lwd = 2)
par(new=TRUE)
...
#plot it!
pdf('C:\\Users\\Kim\\Documents\\ML\\V2\\NHGRI\\models\\T2D_like_lipid_alzheimer\\testing_ROCs.pdf', width = 15, height = 5)

par(mfrow=c(1,3))
plot(T2D_model_alz_testing.perf, main=toupper("T2D_like model on holdouts"), col = "orangered1", cex.axis = 3, lwd = 2)
par(new=TRUE)
plot(T2D_model_lipid_testing.perf, col = "purple1", lwd = 2)
par(new=TRUE)
...
par(new=TRUE)
plot(lipid_model_lipid_testing.perf, col = "purple1", lwd = 2)
par(new=TRUE)
...
#add GWAVA, CADD, & DeepSEA to testing roc plots

T2D_GCD    <-read.delim(file="C:\\Users\\Kim\\Documents\\ML\\V2\\NHGRI\\models\\T2D_like_lipid_alzheimer\\T2D_like_testing_scores_table.txt")

lipid_GCD  <-read.delim(file="C:\\Users\\Kim\\Documents\\ML\\V2\\NHGRI\\models\\T2D_like_lipid_alzheimer\\lipid_testing_scores_table.txt")
...
#and add to plots. 
pdf('C:\\Users\\Kim\\Documents\\ML\\V2\\NHGRI\\models\\T2D_like_lipid_alzheimer\\testing_ROCs_GCD.pdf', width = 15, height = 5)

par(mfrow=c(1,3))
plot(alz_model_T2D_testing.perf, main=toupper("models on T2D holdouts"), col = "#d95f02", cex.axis = 3, lwd = 2)
par(new=TRUE)
plot(lipid_model_T2D_testing.perf, col = "#7570b3", lwd = 2)
par(new=TRUE)
...
par(new=TRUE)
plot(lipid_model_lipid_testing.perf, col = "#7570b3", lwd = 2)
par(new=TRUE)
...
#just my models
pdf('C:\\Users\\Kim\\Documents\\ML\\V2\\NHGRI\\models\\T2D_like_lipid_alzheimer\\testing_ROCs_same_holdouts.pdf', width = 15, height = 5)
...
pdf('C:\\Users\\Kim\\Documents\\ML\\V2\\NHGRI\\models\\T2D_like_lipid_alzheimer\\testing_ROCs_GCD_only.pdf', width = 15, height = 5)
...
T2D_tr_GCD    <-read.delim(file="C:\\Users\\Kim\\Documents\\ML\\V2\\NHGRI\\models\\T2D_like_lipid_alzheimer\\T2D_like_training_scores_table.txt")

lipid_tr_GCD  <-read.delim(file="C:\\Users\\Kim\\Documents\\ML\\V2\\NHGRI\\models\\T2D_like_lipid_alzheimer\\lipid_training_scores_table.txt")
...
pdf('C:\\Users\\Kim\\Documents\\ML\\V2\\NHGRI\\models\\T2D_like_lipid_alzheimer\\training_ROC_GCD.pdf', width = 15, height = 5)
par(mfrow=c(1,3))
